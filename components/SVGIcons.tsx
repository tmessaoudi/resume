...
export function TypeScriptIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 256" class="h-4 w-4" {...props}>
      <path
        fill="#3178C6"
...
export function ReactIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 228" class="h-4 w-4" {...props}>
      <path
        fill="#00D8FF"
...
export function TailwindcssIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 154" class="h-4 w-4" {...props}>
      <defs>
        <linearGradient
...
export function RemixIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 297" class="h-4 w-4" {...props}>
      <path
        fill="#121212"
...
export function FreshIcon(props: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="h-4 w-4"
...
export function DockerIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 185" class="h-4 w-4" {...props}>
      <path
        fill="#2396ED"
...
export function SQLIcon(props: Props) {
  return (
    <svg viewBox="0 0 24 24" class="h-4 w-4" {...props}>
      <path
        fill="currentColor"
...
export function RedisIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 220" class="h-4 w-4" {...props}>
      <path
        fill="#912626"
...
export function LinuxIcon(props: Props) {
  return (
    <svg viewBox="0 0 256 295" class="h-4 w-4" {...props}>
      <defs>
        <linearGradient
